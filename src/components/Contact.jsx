                ...
                <div className="container">
                    <div className="row justify-content-center text-center mb-3">
                        <div className="col-lg-8 col-xxl-7">
                            ...
                            <p className="lead">The best way to contact us is to use our contact form below. Please fill out all of the required fields and we will get back to you as soon as possible.</p>
                        </div>
                    </div>
                            ...
                            <form>
                                ...
                                <div className="col-md-4 ms-auto">
                                    <div className="d-grid">
                                        <button className="btn btn-primary" type="submit" onClick={(e) => e.preventDefault()}>Send message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
